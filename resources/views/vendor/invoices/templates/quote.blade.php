            ...
            <div class="invoice-header">
                ...
                <div class="invoice-meta">
                    <span class="invoice-meta-item">
                        <span class="invoice-meta-label">Quote No.</span>
                        <span class="invoice-meta-value">{{ $invoice->getSerialNumber() }}</span>
                    </span>
                    <span class="invoice-meta-item">
                        <span class="invoice-meta-label">Issued</span>
                        <span class="invoice-meta-value">{{ $invoice->getDate() }}</span>
                    </span>
                    @if ($validUntil = data_get($invoice->getCustomData(), 'valid_until'))
                        <span class="invoice-meta-item">
                            <span class="invoice-meta-label">Valid until</span>
                            <span class="invoice-meta-value">{{ $validUntil }}</span>
                        </span>
                    @endif
                    @if ($projectName = data_get($invoice->getCustomData(), 'project_name'))
                        <span class="invoice-meta-item">
                            <span class="invoice-meta-label">Project</span>
                            <span class="invoice-meta-value">{{ $projectName }}</span>
                        </span>
                    @endif
                </div>
            </div>
